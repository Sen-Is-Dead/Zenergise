...
const Register = () => {
  ...
  const submitRegistration = () => {
    ...
    axios.post("http://192.168.0.29:8000/api/register", { email, password, confirm_password: confirmPassword }, { withCredentials: true })
      .then(response => {
        // Check if login session is established
